...
path rather than a profiling run — see `docs/FINDINGS.md` #22 for the
full finding. Worth logging here per `CLAUDE.md` rule 6 since it's a
performance-relevant change, even though it started from a design
question rather than a measured budget miss.
